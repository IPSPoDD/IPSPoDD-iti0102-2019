...
|____¿|"""
    ...
    def ask_move(self) -> Move:
        ...
        while True:
            try:
                command = input(f"{Color.Fg.cyan}Choose your next move! " + f"{Color.Fg.green} (Use {Color.Fg.light_blue}'help' " + f"{Color.Fg.green}for help) " + f"{Color.Fg.orange}> {Color.reset}")
    ...
    def show_help(self):
        """Show help."""
        print(f"""
        {Color.Fg.light_blue}help {Color.Fg.orange}-> """ + f""""{Color.Fg.green}help {Color.Fg.light_green}(print help/commands to console)
        {Color.Fg.light_blue}hit {Color.Fg.pink}(h) {Color.Fg.orange}-> """ + f""""{Color.Fg.green}hit {Color.Fg.light_green}(get one more card)
        {Color.Fg.light_blue}stand {Color.Fg.pink}(s) {Color.Fg.orange}->  """ + f"""{Color.Fg.green}stand {Color.Fg.light_green}(stop getting more cards, give turn to next player)
        {Color.Fg.light_blue}split {Color.Fg.pink}(x) {Color.Fg.orange}-> """ + f"""{Color.Fg.green}split cards {Color.Fg.light_green}(if you have 2 cards with same value you can """ + f"""split them to 2 different decks)
        {Color.Fg.light_blue}double {Color.Fg.pink}(d) {Color.Fg.orange}-> """ + f"""{Color.Fg.green}double down {Color.Fg.light_green}(double your bet and receive 1 last card)
        {Color.Fg.light_blue}surrender {Color.Fg.pink}(q) {Color.Fg.orange}-> """ + f"""{Color.Fg.light_green}surrender {Color.Fg.light_green}(give up :( ){Color.reset}""")
